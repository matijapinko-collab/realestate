...
export async function generateMetadata({
  ...
  if (!translation) return { title: "Property" };
  return {
...
export default async function PropertyDetailEN({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  const specs = [
    property.livingArea && { label: "Area", value: formatArea(property.livingArea) },
    property.rooms && { label: "Rooms", value: `${property.rooms}` },
    ...
    property.energyClass && { label: "Energy class", value: property.energyClass },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-8">
              ...
              <div className="flex items-center gap-2 text-gray-500 mb-4">
                ...
                <span>{property.locationCity}{property.locationArea && `, ${property.locationArea}`}</span>
              </div>
              <div className="font-playfair text-3xl font-bold text-[#D4AF37]">
                {property.price ? formatPrice(Number(property.price), property.currency) : "On request"}
                {property.transactionType === "RENT" && (
                  <span className="text-base font-sans font-normal text-gray-500 ml-2">/ mo.</span>
                )}
              </div>
            </div>
            ...
            {property.features.length > 0 && (
              <div className="mb-8">
                <h2 className="font-playfair text-2xl font-bold mb-4">Features</h2>
        ...
        {relatedProperties.length > 0 && (
          <div className="mt-16 pt-12 border-t border-gray-100">
            <h2 className="font-playfair text-3xl font-bold mb-8">Related Properties</h2>
